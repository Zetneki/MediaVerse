...
export default function () {
  ...
  // change-password invalidates token (incrementTokenVersion) → re-login required
  group("Users – delete account", () => {
    // 1. change-password with original password
    http.put(
    ...
    // 2. re-login with new password – new token required
